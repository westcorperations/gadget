        ...
        <form action="{{url('update-product/'.$product->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-3 mb-3">
                    <label for=""> cost price </label>
                        <input type="text" name="cost_price"value="{{$product->original_price}}"  class="form-control">
                </div>
                <div class="col-md-3 col-3 mb-3">
                    <label for=""> Tax </label>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-12 mb-3">
                    ...
                    <input type="file" name="image" value="{{$product->image}}}" rows="3" class="form-control">
                </div>
            </div>
            ...
            <div class="row">
                 ...
                 <div class="col-md-12 mb-3">
                    <label for="">  Meta-Title  </label>
                        <textarea  name="meta_title" rows="3" class="form-control">{{$product->meta_title}}</textarea>
                </div>
            </div>
            <div class="row">
